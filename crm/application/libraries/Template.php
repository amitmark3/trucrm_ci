...
class Template
{
	...
	public function set_css($name)
	{
		if (is_array($name))
		{
			...
			{
				$this->_css[$file] = '<link rel="stylesheet" href="'.site_url('assets/css/'.$file).'.css">';
			}
		}
		else
		{
			$this->_css[$name] = '<link rel="stylesheet" href="'.site_url('assets/css/'.$name).'.css">';
		}
		return $this;
	}

	/**
	 * Put js at end of page
	 *
	 * @access	public
	 * @param	string	$name		Name of the file
	 * @return	void
	...
	public function set_js($name)
	{
		if (is_array($name))
		{
			foreach($name as $file)
			{
				$this->_js[$file] = '<script src="'.site_url('assets/js/'.$file).'.js"></script>';
			}
		}
		else
		{
			$this->_js[$name] = '<script src="'.site_url('assets/js/'.$name).'.js"></script>';
		}
		return $this;
	}
	 ...
	 * @return	void
	 */
	public function set_external_js($url)
	{
		$this->_js[$url] = '<script src="'.$url.'"></script>';
		return $this;
	}
