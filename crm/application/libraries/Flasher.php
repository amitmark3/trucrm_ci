...
class Flasher
{
     ...
     * @return void
     */
    public function set_message($message, $type, $url = null, $dismissable = false, $icon = 'info')
    {
        if ( ! $message )
    ...
    {
        $this->set_message($message, 'success', $url, $dismissable, 'check-circle');
    }
    ...
    {
        $this->set_message($message, 'warning', $url, $dismissable, 'exclamation-circle');
    }
     ...
     * @return void
     */
    public function set_warning_extra($message, $url = null, $dismissable = false)
    {
        $this->set_message($message, 'warning-extra', $url, $dismissable, 'exclamation-circle');
    }
    ...
    {
        $this->set_message($message, 'danger', $url, $dismissable, 'exclamation-triangle');
    }
    ...
    public function get_message()
    {
        ...
        $ouput .= '<i class="fa fa-'.$this->flash_message['icon'].'"></i>&nbsp;&nbsp;' . $this->flash_message['message'] . '</div>';
        return $ouput;
    }
