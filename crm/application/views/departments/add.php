<div class="row">
    <div class="col-xs-12">
        <div class="box">
            <?= form_open('departments/add', ['id' => 'add-department-form']) ?>
            <div class="box-body">
                <div class="row">
                ...
                <div class="row">
                    <div class="form-group col-xs-12 col-md-6 col-lg-4">
                        ...
                        <?= form_textarea('description', set_value('description'), ['id' => 'description']) ?>
                ...
                <div class="row">
                    <div class="form-group col-xs-12 col-md-6 col-lg-4">
                        ...
                        <?= form_dropdown('user_id', $users, set_value('user_id'), ['id' => 'user_id', 'class' => 'form-control selectpicker', 'data-container' => 'body']) ?>
                    </div>
                </div>
            </div>
