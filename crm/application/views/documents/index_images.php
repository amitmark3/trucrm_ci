            ...
            <div class="box-body">
                <div class="grid">
                    ...
                    foreach ($files as $file)
                    {
                        ...
                        {
                            echo '<a href="'.site_url('uploads/'.$this->company['uploads_folder'].'/'.$file).'" target="_blank" title="'.$file.'">';
                            echo '<img src="'.site_url('uploads/'.$this->company['uploads_folder'].'/'.$file).'" alt="'.$file.'" width="200px" class="img-responsive">';
