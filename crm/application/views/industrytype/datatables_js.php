<script type="text/javascript">
    $(document).ready(function() {
        var table = $('#industry_type_data').DataTable( {
            "searching": true,
            "processing": true,
            "serverSide": true,
            "pageLength": 25,
            ...
            "columnDefs": [
                ...
                /*{
                    ...
                    "render": function ( data ) {
                        return '<a href="<?= site_url('industrytype/view') ?>/'+data+'">'+data+'</a>';
                    },
                },*/
                {
                    "targets": [3],
    ...
    $(document).on("click", ".confirm", function(e) {
        e.preventDefault();
        var id = $(this).attr('id');
        var url = '<?= site_url('industrytype/delete') ?>';
        bootbox.dialog({
            message: "Are you sure you want to delete this industry type?",
