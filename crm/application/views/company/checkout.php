    ...
    <div class="col-xs-12 col-md-10 col-md-offset-1 col-lg-8 col-lg-offset-2">
        <div class="box box-danger box-onboarding">
            <div class="box-body text-center">
                <h1 class="uppercase" style="margin:0.6em;">Checkout</h1>
                    ...
                    <div class="col-xs-8 col-xs-offset-2">
                        <div class="box box-danger box-solid box-order-summary">
                            ...
                            <div class="box-body">
                                ...
                                <form action="<?= site_url('company/stripe_charge') ?>" method="POST">
                                    <script
                                    src="https://checkout.stripe.com/checkout.js" class="stripe-button"
                                    data-key="<?= $this->config->item('publishableKey') ?>"
                                    data-name="<?= $this->config->item('website_title') ?>"
                                    data-amount="<?= $price_plan['price'] * 100 ?>"
                                    data-email="<?= $company_admin['email'] ?>"
                                    data-name="Trucrm by Mark3"
                                    data-description="<?= $price_plan['name']. ' Plan' ?>"
                                    data-locale="auto"
                                    data-currency="eur">
                                    </script>
                                </form>
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <p>We use Stripe because it allows us to NOT store credit / debit card details ourselves. This make the payment process more secure as Stripe deal with all the neccessary laws when it comes to collecting and storing card details.</p>
                <p><strong>Your card details do not touch our server at any time.</strong></p>
                <p>Read more about Stripe <a href="https://stripe.com/about" target="_blank">here</a>.</p>
                <hr>
