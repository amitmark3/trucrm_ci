...
class Project_model extends MY_Model
{
    ...
    public function __construct()
    {
		...
		$this->has_one['project_time'] = [
            'foreign_model' => 'project_time_model',
            'foreign_table' => 'data_project_time',
            'foreign_key'   => 'id',
            'local_key'     => 'data_project_id',
        ];
	 ...
	 * Update 
	*/	
	public function updateProject($post_data, $update_row_id)
	{ 	
